...
* Все — значения. Типы — это просто более широкие значения.
* CUE строит и проверяет конфигурации с помощью **математики решетки**.
* Конфликты сразу выявляются, нет скрытого переопределения.
* Конъюнкция уточняет, дизъюнкция объединяет.

---

Если хочешь, я могу нарисовать **визуальную схему решетки CUE** с уровнями `_`, типами, значениями и `_|_` — это сильно помогает понять философию наглядно.
